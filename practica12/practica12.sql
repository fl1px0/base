...
Insert INTO order_history (product_id, quantity_changed,notes) VALUES (1,-5,'Продано 5 ноутбуков');
...
INSERT INTO order_history (product_id,quantity_changed,notes) VALUES (2,-100,"Продано 100 смартфонов");
